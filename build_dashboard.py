...
def _dark(fig: go.Figure, height: int) -> go.Figure:
    fig.update_layout(
        ...
        # Keep l/r equal (and tight) so the plot fills the card with a small,
        # balanced gutter — just enough for the y tick labels to fit.
        height=height, margin=dict(l=26, r=26, t=44, b=40),
...
def night_fig(n: Night, anon: bool = False) -> go.Figure:
    ...
    fig.update_layout(margin=dict(l=26, r=26, t=64, b=40),
